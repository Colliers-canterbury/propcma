...
(function () {
  ...
  const state = {
    ...
    f: {
      ...
      specialClauses: false, specialClausesText: "",
        ...
        <main>
          ...
          ${section("7","Deposit — trust account","Complete if a deposit will be paid into the Colliers trust account.",
            `<div style="display:flex;gap:24px;flex-wrap:wrap;align-items:center;">
              ${chk("depositToTrust","Deposit paid into the trust account")}
              ${chk("specialClauses","Special Clauses")}
            </div>` +
            (f.specialClauses?`<div class="grid" style="margin-top:12px">
              ${txt("specialClausesText","Special clauses",{span:3,ph:"e.g. Sunset Clause Date"})}</div>`:"") +
            (f.depositToTrust?`
